...
def ga(model, generations, mutation_range, x_min, x_max, y_min, y_max, function, first_constraint, second_constraint, initial_population_dict, population_size):
    #initial_population = population_generator(100, x_min, x_max, y_min, y_max, first_constraint, second_constraint)
    print('initial population:', initial_population_dict)
    ...
    for i in range(generations):
        ...
        # print("new generation before mutation:", new_gen_before)
